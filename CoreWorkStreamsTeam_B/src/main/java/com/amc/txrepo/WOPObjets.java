...
public class WOPObjets extends TxBase {
	...
	public void Login(String UsrName) throws Exception {
		...
		if(loginState.equalsIgnoreCase("User Already loggedin")) {
			System.out.println("User Already loggedin need to enter Password");
			...
			selectProgrameType(); // Select Application based on Input
		}
	}
	...
	public void selectProgrameType() throws Exception {
		...
		excelUtilsRemote.readingexcelFiles("RemoteFiles");

		openRemoteDesktopFile(excelUtilsRemote.excelData[1][0]);
